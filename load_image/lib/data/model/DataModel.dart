...
String photoDataToJson(List<PhotoData> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class PhotoData {
    ...
    factory PhotoData.fromJson(Map<String, dynamic> json) => PhotoData(
        ...
        links: PhotoDatumLinks.fromJson(json["links"]),
...
class PhotoDatumLinks {
    ...
    factory PhotoDatumLinks.fromJson(Map<String, dynamic> json) => PhotoDatumLinks(
        self: json["self"],
        html: json["html"],
